...
Front page: path/arabic, path/tamil, path/roundtrip (stress+torture), path/research. Reverse-map rows identity; HindiC whole-file may residue — reported, not painted.
