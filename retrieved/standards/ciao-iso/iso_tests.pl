...
clause_test6(Body) :- C = x, clause(C, Body). % TODO:[JF] execute as 'user' code? no compile time error?
...
clause_test12 :- C = f(_), clause(C, 5). % TODO:[JF] execute as 'user' code? no compile time error?
