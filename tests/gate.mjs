...
const jobs = ["tests/run.mjs", "tests/elseif.mjs", "tests/nb_run.mjs", "tests/app_frontends.mjs", "tests/shell.mjs", "tests/console_page.mjs", "tests/oop_fp.mjs", "tests/gate_cse.mjs", "tests/pspice.mjs"];
let fail = 0;
for (const j of jobs) {
